...
class Joc {
	...
	char* nume;
	int nrEroi;
	Erou   eroi[5];// ca daca alegi compunerea asta...s e apelaza mereu default cosnt fara pram (ala din erou )sa iti aloce memorie pt vectorul de 5 eroi... asta cand cosntruim un Joc   
