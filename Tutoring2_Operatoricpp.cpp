...
public :
	Mesaj(int prioritate, string text) {
	...
	//operatorul egal este oblig incarcat prin functie membra
	//pt return void operatorul nu se poate apela in cascada;
	...
	Mesaj operator++(int) {
		//Mesaj ++
		//pos incrementare
		//copie inainte de a modifica this
		Mesaj copie = *this;
		this->prioritate += 1;
		return copie;
	}
